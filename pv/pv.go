...
func (u Unit) String() string{
	...
	switch {
	case u >= G: return fmt.Sprintf(fm, float64(u)/G, "G")
	case u >= M: return fmt.Sprintf(fm, float64(u)/M, "M")
	case u >= K: return fmt.Sprintf(fm, float64(u)/K, "K")
	default:     return fmt.Sprintf(fm, float64(u)/B, "B")
	}
}
